...
import penakelex.textRPG.homeland.Databases.HealthDatabase.HealthDatabase;
...
public class HealthStatusAdapter extends RecyclerView.Adapter<HealthStatusAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(listener -> clickListener.onClickListener(information.get(position).getName(), position, information.get(position).getValue()));
    }
